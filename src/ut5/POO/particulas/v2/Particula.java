    ...
    public void mover(int ancho, int alto) {
        switch (this.direccion) {
            ...
            case 1:
                ...
                if (pos.getX() >= ancho - tamaño) this.direccion = 2;
                break;
            case 2:
            ...
            case 3:
                ...
                if (pos.getY() >= alto - tamaño) this.direccion = 0;
                break;
            case 4:
            ...
            case 6:
                ...
                else if (pos.getY() >= alto - tamaño) this.direccion = 4;
                break;
            case 7:
                this.pos.diagonalLeftBot(velocidad, velocidad);
                if (pos.getX() <= 0) this.direccion = 6;
                else if (pos.getY() >= alto - tamaño) this.direccion = 5;
                break;
        }
